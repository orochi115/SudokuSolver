...
export const CHAIN_OWNERSHIP: readonly ChainOwnership[] = [
  ...
  // ---- P0 newly registered (gate 6 boundaries updated) ----
  {
    strategyId: 'xy-chain',
  ...
  },
  {
    ...
    owns: 'Continuous / discontinuous single-digit & general Nice Loops (AicResult *-loop kinds). E6: aic must not emit loop kinds.',
    multiBranch: false,
    profiles: ['human-default', 'last-resort'],
  },
];
