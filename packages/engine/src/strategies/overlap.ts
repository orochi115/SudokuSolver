...
export const OVERLAP_FAMILIES: readonly OverlapFamily[] = [
  {
    ...
    note:
      ...
      'E2: unified=true since turbot-fish now provides the generic 4-cell detector.',
  },
  {
    id: 'aic-chain',
    canonicalOwner: 'aic',
    ...
    note:
      ...
      'are now handled by the nice-loop strategy (E6: loop kinds transferred from aic to nice-loop).',
  },
  {
    id: 'als-chain',
  ...
  },
  {
    ...
    note:
      ...
      'unique-solution assumption. E3: UR types 3/5/6 and Hidden UR now share the allRectangles generator via ur-extended.ts.',
  },
];
