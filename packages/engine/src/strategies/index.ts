...
import { alsXz, alsXzDoublyLinked, deathBlossom } from './als.js';
import { alsChain, alsXyWing } from './als-chain.js';
...
import { uniqueLoop } from './unique-loop.js';
import { bugLite } from './bug-lite.js';
import { bugPlusN } from './bug-plus-n.js';
...
export const STRATEGIES: readonly Strategy[] = [
  ...
  // Advanced wings (5xx) · Coloring (6xx) · Chains (7xx) · ALS (8xx) · Uniqueness (9xx) · Exotic (1xxx)
  remotePairs,        // 505
  turbotFish,         // 510
  wxyzWing,           // 520
  bentSets,           // 540
