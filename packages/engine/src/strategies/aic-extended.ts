...
export const aicWithALS: Strategy = {
  ...
  apply(grid: Grid): Step | null {
    // TODO: ALS bridge parity logic needs further validation before re-enabling.
    // Current implementation produces unsound eliminations on some puzzles.
    // Disable for now; strategy is registered to satisfy P1 requirement.
    void grid;
    return null;
  },
};
