...
<link rel="mask-icon" href="//a.fsdn.com/con/img/sandiego/svg/originals/sf-icon-orange-no_sf.svg" color="#FF6600">
        ...
        <script>
            ...
            if (!window.SF) {
                window.SF = {};
            }SF.EU_country_codes = ["SI","VG","AI","MS","IS","TF","CZ","RO","ES","PF","HU","GS","IO","DE","GB","WF","LI","PM","NC","BG","NL","MT","PL","SE","GF","FR","SX","KY","GR","RE","CH","LV","FI","BE","SK","CW","GL","JE","GI","BM","GG","YT","AT","AW","MF","GP","FK","CY","SH","TC","IE","MQ","LU","LT","IT","ME","DK","EE","PN","PT","AX","BL","NO","HR"];
        ...
        <style>.i08dbc6c0279cfa9300ec7b93c3018583035e0617 { display: none !important; }</style>
...
<span id="d14a1919-3e19-4a84-97e7-117e831e460e"></span>
<script>
    /* globals bizx */
    bizx.cmp.trackingPixel('publisher', ['storage', 'measurement'], '/software/tp3/?b=89678&amp;c=16291&amp;z=87086&amp;cb=071bde2376&amp;rand=d14a1919-3e19-4a84-97e7-117e831e460e', "Captain Compliance - Data Privacy and Compliance Software", 'd14a1919-3e19-4a84-97e7-117e831e460e');
</script>
...
<span id="27a2a37d-35ed-4c03-bd05-d76e38f087e5"></span>
<script>
    /* globals bizx */
    bizx.cmp.trackingPixel('publisher', ['storage', 'measurement'], '/software/tp3/?b=89678&amp;c=16291&amp;z=87086&amp;cb=071bde2376&amp;rand=27a2a37d-35ed-4c03-bd05-d76e38f087e5', "Captain Compliance - Data Privacy and Compliance Software", '27a2a37d-35ed-4c03-bd05-d76e38f087e5');
</script>
...
try{
    ...
    <script>
        ...
        function loadimg(params, dimension_prefix) {
            params = Object.assign({"idsite":1,"rec":1,"rand":45316,"dimension2":"pg_project","url":"https://sourceforge.net/projects/hodoku/","action_name":"Sudoku for Java - HoDoKu download | SourceForge.net"}, params);
