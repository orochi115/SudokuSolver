...
<link rel="mask-icon" href="//a.fsdn.com/con/img/sandiego/svg/originals/sf-icon-orange-no_sf.svg" color="#FF6600">
        ...
        <script>
            ...
            if (!window.SF) {
                window.SF = {};
            }SF.EU_country_codes = ["AW","TF","HU","BM","SI","LU","SK","SE","FK","JE","GP","MT","CZ","AT","GL","PN","PT","TC","NO","BG","PM","GI","MQ","MF","PL","GB","FR","RO","YT","IE","IT","LV","ME","GF","GS","MS","RE","FI","NC","CY","WF","AX","IS","VG","KY","HR","IO","GG","LI","SH","PF","CW","BL","AI","CH","GR","NL","DK","LT","DE","EE","BE","SX","ES"];
        ...
        <style>.P8180592320f9e7946aa46a114932f0cc4c831b03 { display: none !important; }</style>
...
<span id="3501c52b-f6a0-45d3-b07b-5eedf98ddbce"></span>
<script>
    /* globals bizx */
    bizx.cmp.trackingPixel('publisher', ['storage', 'measurement'], '/software/tp3/?b=88834&amp;c=16176&amp;z=86240&amp;cb=4787884e8f&amp;rand=3501c52b-f6a0-45d3-b07b-5eedf98ddbce', "Zendesk: The Complete Customer Service Solution", '3501c52b-f6a0-45d3-b07b-5eedf98ddbce');
</script>
...
<span id="8255511f-56a4-45e9-bd20-285b89412905"></span>
<script>
    /* globals bizx */
    bizx.cmp.trackingPixel('publisher', ['storage', 'measurement'], '/software/tp3/?b=88834&amp;c=16176&amp;z=86240&amp;cb=4787884e8f&amp;rand=8255511f-56a4-45e9-bd20-285b89412905', "Zendesk: The Complete Customer Service Solution", '8255511f-56a4-45e9-bd20-285b89412905');
</script>
...
try{
    ...
    <script>
        ...
        function loadimg(params, dimension_prefix) {
            params = Object.assign({"idsite":1,"rec":1,"rand":11664,"dimension2":"pg_project","url":"https://sourceforge.net/projects/hodoku/","action_name":"Sudoku for Java - HoDoKu download | SourceForge.net"}, params);
