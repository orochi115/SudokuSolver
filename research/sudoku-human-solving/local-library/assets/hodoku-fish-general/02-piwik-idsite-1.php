...
<link rel="mask-icon" href="//a.fsdn.com/con/img/sandiego/svg/originals/sf-icon-orange-no_sf.svg" color="#FF6600">
        ...
        <script>
            ...
            if (!window.SF) {
                window.SF = {};
            }SF.EU_country_codes = ["SK","YT","SH","VG","IE","LI","AW","PL","GI","AT","LV","GS","SX","GR","PT","MS","SI","NO","AI","BG","DK","AX","GB","TF","KY","RE","MT","TC","NC","LT","MF","CH","GG","BE","ES","PF","PN","IT","GL","CZ","HR","IO","GF","DE","MQ","BL","FI","BM","EE","PM","HU","SE","NL","FR","GP","RO","JE","LU","FK","CY","CW","IS","WF","ME"];
        ...
        <style>.A24cb798bc5c92b5da3c18c1016caacd640980233 { display: none !important; }</style>
...
<span id="a0cb4932-96c7-44dc-bd82-d37346c9576a"></span>
<script>
    /* globals bizx */
    bizx.cmp.trackingPixel('publisher', ['storage', 'measurement'], '/software/tp3/?b=54083&amp;c=10513&amp;z=51413&amp;cb=23a0363d6f&amp;rand=a0cb4932-96c7-44dc-bd82-d37346c9576a', "Go beyond a virtual data room with Datasite Diligence", 'a0cb4932-96c7-44dc-bd82-d37346c9576a');
</script>
...
<span id="93162be9-9c53-461a-b913-f5a675a8cb78"></span>
<script>
    /* globals bizx */
    bizx.cmp.trackingPixel('publisher', ['storage', 'measurement'], '/software/tp3/?b=54083&amp;c=10513&amp;z=51413&amp;cb=23a0363d6f&amp;rand=93162be9-9c53-461a-b913-f5a675a8cb78', "Go beyond a virtual data room with Datasite Diligence", '93162be9-9c53-461a-b913-f5a675a8cb78');
</script>
...
try{
    ...
    <script>
        ...
        function loadimg(params, dimension_prefix) {
            params = Object.assign({"idsite":1,"rec":1,"rand":71252,"dimension2":"pg_project","url":"https://sourceforge.net/projects/hodoku/","action_name":"Sudoku for Java - HoDoKu download | SourceForge.net"}, params);
