...
[![Image 1: Sudoku technique: Example for Finned+X-Wing](../../assets/hodoku-finned-fish/01-fbf201.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fbf201&tech=Finned+X-Wing)[![Image 2: Sudoku technique: Example for %28Finned%29+Sashimi+X-Wing](../../assets/hodoku-finned-fish/02-sbf201.png)](https://hodoku.sourceforge.net/en/show_example.php?file=sbf201&tech=%28Finned%29+Sashimi+X-Wing)
...
[![Image 3: Sudoku technique: Example for Finned+Swordfish](../../assets/hodoku-finned-fish/03-fbf301.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fbf301&tech=Finned+Swordfish)[![Image 4: Sudoku technique: Example for %28Finned%29+Sashimi+Swordfish](../../assets/hodoku-finned-fish/04-sbf301.png)](https://hodoku.sourceforge.net/en/show_example.php?file=sbf301&tech=%28Finned%29+Sashimi+Swordfish)
...
[![Image 5: Sudoku technique: Example for Finned+Jellyfish](../../assets/hodoku-finned-fish/05-fbf401.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fbf401&tech=Finned+Jellyfish)[![Image 6: Sudoku technique: Example for %28Finned%29+Sashimi+Jellyfish](../../assets/hodoku-finned-fish/06-sbf401.png)](https://hodoku.sourceforge.net/en/show_example.php?file=sbf401&tech=%28Finned%29+Sashimi+Jellyfish)
