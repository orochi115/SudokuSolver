...
[![Image 1: Sudoku technique: Example for Naked+Pair](https://hodoku.sourceforge.net/examples/n201.png)](https://hodoku.sourceforge.net/en/show_example.php?file=n201&tech=Naked+Pair)[![Image 2: Sudoku technique: Example for Naked+Pair](https://hodoku.sourceforge.net/examples/n202.png)](https://hodoku.sourceforge.net/en/show_example.php?file=n202&tech=Naked+Pair)
...
[![Image 3: Sudoku technique: Example for Locked+Pair](https://hodoku.sourceforge.net/examples/l201.png)](https://hodoku.sourceforge.net/en/show_example.php?file=l201&tech=Locked+Pair)[![Image 4: Sudoku technique: Example for Locked+Pair](https://hodoku.sourceforge.net/examples/l202.png)](https://hodoku.sourceforge.net/en/show_example.php?file=l202&tech=Locked+Pair)
...
[![Image 5: Sudoku technique: Example for Naked+Triple](https://hodoku.sourceforge.net/examples/n301.png)](https://hodoku.sourceforge.net/en/show_example.php?file=n301&tech=Naked+Triple)[![Image 6: Sudoku technique: Example for Naked+Triple](https://hodoku.sourceforge.net/examples/n302.png)](https://hodoku.sourceforge.net/en/show_example.php?file=n302&tech=Naked+Triple)
...
[![Image 7: Sudoku technique: Example for Locked+Triple](https://hodoku.sourceforge.net/examples/l301.png)](https://hodoku.sourceforge.net/en/show_example.php?file=l301&tech=Locked+Triple)[![Image 8: Sudoku technique: Example for Locked+Triple](https://hodoku.sourceforge.net/examples/l302.png)](https://hodoku.sourceforge.net/en/show_example.php?file=l302&tech=Locked+Triple)
...
[![Image 9: Sudoku technique: Example for Naked+Quadruple](https://hodoku.sourceforge.net/examples/n401.png)](https://hodoku.sourceforge.net/en/show_example.php?file=n401&tech=Naked+Quadruple)[![Image 10: Sudoku technique: Example for Naked+Quadruple](https://hodoku.sourceforge.net/examples/n402.png)](https://hodoku.sourceforge.net/en/show_example.php?file=n402&tech=Naked+Quadruple)
