...
[![Image 1: Sudoku technique: Example for Forcing+Chain+Verity+%28all+chains%29](../../assets/hodoku-last/01-fcv01.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fcv01&tech=Forcing+Chain+Verity+%28all+chains%29)[![Image 2: Sudoku technique: Example for Forcing+Chain+Verity+%28only+chain+1%29](../../assets/hodoku-last/02-fcv02.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fcv02&tech=Forcing+Chain+Verity+%28only+chain+1%29)[![Image 3: Sudoku technique: Example for Forcing+Chain+Verity+%28only+chain+2%29](../../assets/hodoku-last/03-fcv03.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fcv03&tech=Forcing+Chain+Verity+%28only+chain+2%29)[![Image 4: Sudoku technique: Example for Forcing+Chain+Verity+%28only+chain+3%29](../../assets/hodoku-last/04-fcv04.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fcv04&tech=Forcing+Chain+Verity+%28only+chain+3%29)
...
[![Image 5: Sudoku technique: Example for Forcing+Net+Verity+%28all+chains%29](../../assets/hodoku-last/05-fnv01.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fnv01&tech=Forcing+Net+Verity+%28all+chains%29)[![Image 6: Sudoku technique: Example for Forcing+Net+Verity+%28only+net+1%29](../../assets/hodoku-last/06-fnv02.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fnv02&tech=Forcing+Net+Verity+%28only+net+1%29)[![Image 7: Sudoku technique: Example for Forcing+Net+Verity+%28only+net+2%29](../../assets/hodoku-last/07-fnv03.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fnv03&tech=Forcing+Net+Verity+%28only+net+2%29)[![Image 8: Sudoku technique: Example for Forcing+Net+Verity+%28only+net+3%29](../../assets/hodoku-last/08-fnv04.png)](https://hodoku.sourceforge.net/en/show_example.php?file=fnv04&tech=Forcing+Net+Verity+%28only+net+3%29)
...
[![Image 9: Sudoku technique: Example for Kraken+Fish+Type+1+%28Chain+1%29](../../assets/hodoku-last/09-kf101.png)](https://hodoku.sourceforge.net/en/show_example.php?file=kf101&tech=Kraken+Fish+Type+1+%28Chain+1%29)[![Image 10: Sudoku technique: Example for Kraken+Fish+Type+1+%28Chain+2%29](../../assets/hodoku-last/10-kf102.png)](https://hodoku.sourceforge.net/en/show_example.php?file=kf102&tech=Kraken+Fish+Type+1+%28Chain+2%29)
...
[![Image 11: Sudoku technique: Example for Kraken+Fish+Type+2+%28Fish+only%29](../../assets/hodoku-last/11-kf201.png)](https://hodoku.sourceforge.net/en/show_example.php?file=kf201&tech=Kraken+Fish+Type+2+%28Fish+only%29)[![Image 12: Sudoku technique: Example for Kraken+Fish+Type+2+%28Chain+1%29](../../assets/hodoku-last/12-kf202.png)](https://hodoku.sourceforge.net/en/show_example.php?file=kf202&tech=Kraken+Fish+Type+2+%28Chain+1%29)[![Image 13: Sudoku technique: Example for Kraken+Fish+Type+2+%28Chain+2%29](../../assets/hodoku-last/13-kf203.png)](https://hodoku.sourceforge.net/en/show_example.php?file=kf203&tech=Kraken+Fish+Type+2+%28Chain+2%29)[![Image 14: Sudoku technique: Example for Kraken+Fish+Type+2+%28Chain+3%29](../../assets/hodoku-last/14-kf204.png)](https://hodoku.sourceforge.net/en/show_example.php?file=kf204&tech=Kraken+Fish+Type+2+%28Chain+3%29)
