...
[![Image 1: Sudoku technique: Example for Hidden+Pair](https://hodoku.sourceforge.net/examples/h201.png)](https://hodoku.sourceforge.net/en/show_example.php?file=h201&tech=Hidden+Pair)[![Image 2: Sudoku technique: Example for Hidden+Pair](https://hodoku.sourceforge.net/examples/h202.png)](https://hodoku.sourceforge.net/en/show_example.php?file=h202&tech=Hidden+Pair)
...
[![Image 3: Sudoku technique: Example for Hidden+Triple](https://hodoku.sourceforge.net/examples/h301.png)](https://hodoku.sourceforge.net/en/show_example.php?file=h301&tech=Hidden+Triple)[![Image 4: Sudoku technique: Example for Hidden+Triple](https://hodoku.sourceforge.net/examples/h302.png)](https://hodoku.sourceforge.net/en/show_example.php?file=h302&tech=Hidden+Triple)
...
[![Image 5: Sudoku technique: Example for Hidden+Quadruple](https://hodoku.sourceforge.net/examples/h401.png)](https://hodoku.sourceforge.net/en/show_example.php?file=h401&tech=Hidden+Quadruple)[![Image 6: Sudoku technique: Example for Hidden+Quadruple](https://hodoku.sourceforge.net/examples/h402.png)](https://hodoku.sourceforge.net/en/show_example.php?file=h402&tech=Hidden+Quadruple)
...
[![Image 7: Sudoku technique: Example for Hidden+Pair](https://hodoku.sourceforge.net/examples/h203.png)](https://hodoku.sourceforge.net/en/show_example.php?file=h203&tech=Hidden+Pair)
