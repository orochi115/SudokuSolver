Title: Y-Wing Strategy - SudokuWiki.org

URL Source: https://www.sudokuwiki.org/Y_Wing_Strategy
...
[Print Version](https://www.sudokuwiki.org/Print_Y_Wing_Strategy)
...
Y-Wing Figure 2 
 ...
 So whatever happens, C is certain in one of those two cells marked C. The red C can be 'seen' by both C s - the cell is a confluence of both BC and AC.
...
*   [Exemplar 1, x3 (score 6.4)](https://www.sudokuwiki.org/sudoku.htm?bd=050000080000086000000201070009020601280000054703060900090605000000170000030000010)
*   [Exemplar 2, x3 (score 6.9)](https://www.sudokuwiki.org/sudoku.htm?bd=009600000000025090400001078901040800000000000002070906370800002020510000000002400)
*   [Exemplar 3, x3 (score 6.1)](https://www.sudokuwiki.org/sudoku.htm?bd=009765000600400007070000500090024000500000003000910070005000090100007004000156800)
*   [Exemplar 4, x3 (score 6.4)](https://www.sudokuwiki.org/sudoku.htm?bd=100007600008010020306020000020000075000385000450000080000040203010030800009700004)
*   [Exemplar 5, x4 (score 6.7)](https://www.sudokuwiki.org/sudoku.htm?bd=000000001004060208070320400900018000005000600000540009008037040609080300100000000)
*   [Exemplar 6, x3 (score 6.9)](https://www.sudokuwiki.org/sudoku.htm?bd=306709405070030000000000070130080002000010000200070049020000000000050060403806207)
*   [Exemplar 7, x3 (score 7.0)](https://www.sudokuwiki.org/sudoku.htm?bd=002070500000805000080020060090000031005609700140000020030090050000102000007040800)
*   [Exemplar 8, x3 (score 7.2)](https://www.sudokuwiki.org/sudoku.htm?bd=005000000090803000001200536060300000203000801000008090186004900000901040000000600)
*   [Exemplar 9, x3 (score 7.2)](https://www.sudokuwiki.org/sudoku.htm?bd=003608000207000000000700340000000019301209507490000000076005000000000208000806700)
*   [Exemplar 10, x3 (score 7.6)](https://www.sudokuwiki.org/sudoku.htm?bd=400000006026000070080040090007800200100302007005004800070020080090000160600000003)

Go back to [Chute Remote Pairs](https://www.sudokuwiki.org/Chute_Remote_Pairs)Continue to [W-Wings](https://www.sudokuwiki.org/W_Wing_Strategy)
...
[](https://www.sudokuwiki.org/Y_Wing_Strategy)Comments[Talk](https://www.sudokuwiki.org/Y_Wing_Strategy?talk#comments)

## ... by: blortch1

Thursday 9-Apr-2026

Y-wings eliminations look suspiciously like XY chain eliminations. I don't see the point of making note of a "y-wing"

Andrew Stuart writes:

I think they are sufficiently distinct to make a difference. And they do share eliminations similarities, yes. It’s about identifying a pattern.
...
Loved Your examples! Wondering if this definition of a Y-Wing needs work:
...
Katie replies:Friday 5-Jul-2024
I was wondering the same thing- I think it has to do with which one can see both others? For instance, in example 1, J2 and B3 cannot see *each other*, so neither can be the pivot.
...
Botfish replies:Sunday 9-Mar-2025
Chess, specifically. 
...
REPLY TO THIS POST
 ...
 Article created on 11-April-2008. Views: 1009618
