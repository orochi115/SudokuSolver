Title: X-Cycles - SudokuWiki.org

URL Source: https://www.sudokuwiki.org/X_Cycles
...
[Print Version](https://www.sudokuwiki.org/Print_X_Cycles)

[Page Index](https://www.sudokuwiki.org/Site_Map)

# X-Cycles

X-Cycles are the start of a large family of 'chaining strategies' which are fundamental to solving the harder Sudoku puzzles. X-Cycles are strongly related to [Simple Coloring](https://www.sudokuwiki.org/Simple_Colouring).
...
So any 8s found in any units which contain weak links - and are NOT part of the chain - can be eliminated - which makes it a powerful technique. We end up with a loop containing only strong links – a result identical to a Colouring ([Simple Colouring](https://www.sudokuwiki.org/Simple_Colouring)) solution. 
...
[](https://www.sudokuwiki.org/X_Cycles)Comments[Talk](https://www.sudokuwiki.org/X_Cycles?talk#comments)
...
You are correct that -3[A2] to +3[C1] is a strong link and you can continue from +3[C1] to -3[C5] but you can’t go any further. Too many 3s in column 5 and you came in with the wrong parity.
...
Eduad Koryagin replies:Wednesday 18-Feb-2026
2 strong links here: +3[A2]-3[C1]+3[C5]-
...
You might not have read as far as this page: [Weak and Strong Links](https://www.sudokuwiki.org/Weak_and_Strong_Links)
...
[Here is a link to your puzzle](https://www.sudokuwiki.org/sudoku.htm?bd=003000901196700500000190060000479613019000708307801290071945006005087109900610000). But I can't see the X-Cycle.
...
Mike Van Emmerik replies:Sunday 6-Sep-2015
...
LeProf replies:Sunday 9-Feb-2014
...
LeProf replies:Sunday 9-Feb-2014
In re: previous lengthy Comment:
...
That elimination is an X-Cycle "Nice Loops Rule 2", two string links. An example is at the top of [this page](https://www.sudokuwiki.org/X_Cycles_Part_2).
...
REPLY TO THIS POST
 ...
 Article created on 12-April-2008. Views: 428768

 This page was last modified on 25-February-2026.
