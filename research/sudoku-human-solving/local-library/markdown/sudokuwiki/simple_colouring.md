Title: Simple Colouring - SudokuWiki.org

URL Source: https://www.sudokuwiki.org/Simple_Colouring
...
[Print Version](https://www.sudokuwiki.org/Print_Simple_Colouring)
...
Simple Colouring, also known as **Single's Chains** is a chaining strategy and part of a large family of such strategies. 'Simple' refers to the idea that one candidate number is considered - in contrast to 'multi-colouring' which is the basis of [3D Medusa](https://www.sudokuwiki.org/3D_Medusa). Simple Colouring also related to [X-Cycles](https://www.sudokuwiki.org/X_Cycles).
...
Just a note on rule numbers: The solver uses the same search algorithm for both Simple Colouring and [3D Medusa](https://www.sudokuwiki.org/3d_medusa) so I have synchronised the rule numbers that are returned. Rules 1 and 3 apply only to 3D Medusa (Multi-colouring) since they extend chains to different numbers. However, the solver needs to look for Simple Colouring first because I deem it to be a simpler strategy that's easier to search for.
...
[](https://www.sudokuwiki.org/Simple_Colouring)This rule is shared with [3D Medusa](https://www.sudokuwiki.org/3D_Medusa).
...
_(Actually yellow is the colour I use to show eliminated candidates. The solver will return Green and Blue for the colouring but then switch one or other to yellow if the candidates are to be eliminated)._ [Example updated April 2026]
...
Single Chains Rule 4 : [Load Example](https://www.sudokuwiki.org/sudoku.htm?bd=S9B0d0e074zc27n021f0c0b0h0c1f05041f0g090i06010b0c0g0d0e08030l1g07040h091f051f0g0i0e0b0c0h0d1f050d080i01060g0c02070c1o4z4y0l05091m080i1m03070e1f0b1n1f0l050d8i7o030h0g) or : [From the Start](https://www.sudokuwiki.org/sudoku.htm?bd=007000200000054009061000008300740905000000000508016002700000590800370000005000300)
 ...
 If we can eliminate "off chain" in a cell we can certainly do so off-chain. This is a great example puzzle for Rule 4 - there are two in succession and I'm showing the first here. Consider the row J elimination in J3. Either H2 is 7 or - follow the chain - J8 is 7. One or the other. Since the 7 at J3 can see both ends of the chain it can be removed. You've heard that story before in earlier strategies. With Simple Colouring the 7 in J3 can 'see' two different colours elsewhere. Same rule applies to H5.

If you have looked at [X-Cycles](https://www.sudokuwiki.org/X_Cycles) you'll spot how these two strategies overlap - if your colouring happens to form a loop, as it does here. Also, if you've read as far as AICs you may recognize the pattern of 3s as a classic double alternating Nice Loop with a discontinuity in B5. But that's another story.
...
_The documentation on this page has changed in February 2015 when a reader called **FallsOffRocks** wrote to me to point out the algorithm for the old Rule 5 could always get all Rule 4 eliminations. So have rolled Rule 5 into Rule 4. Both rules are examples of off-chain eliminations looking at candidates in different cells. The simplification also affects [3D Medusa](https://www.sudokuwiki.org/3D\_Medusa)._

The strategy which naturally follows on from Singles Chains is [3D Medusa](https://www.sudokuwiki.org/3D_medusa), but you should also read up on the article [Introducing Chains and Links](https://www.sudokuwiki.org/Introducing_Chains_and_Links).

## Simple Colouring Exemplars

 These puzzles require Simple Colouring strategy twice at some point and are graded tough so some other similar level strategies also required.

 New examples added April 2026.

 They make good practice puzzles.

 COPYTHIS *   [Exemplar 1 (x2, score 7.15)](https://www.sudokuwiki.org/sudoku.htm?bd=6.2.7...9...4.........2..7.5.....631.76...54.134.....2.4..1.........2...2...4.1.6)
*   [Exemplar 2 (x2, score 7.39)](https://www.sudokuwiki.org/sudoku.htm?bd=.2.4.6.....5.8..26.1..........76...54..3.1..71...92..........1.89..1.4.....2.9.3.)
*   [Exemplar 3 (x2, score 7.44)](https://www.sudokuwiki.org/sudoku.htm?bd=.3.....92...8.43....2...4.5....51...9.......3.2.96......8........42.8...76.....1.)
*   [Exemplar 4 (x2, score 7.56)](https://www.sudokuwiki.org/sudoku.htm?bd=5.7.8...28...2.........9.7......7.8....3.6....5.2..1...365.............72.....4.1)
*   [Exemplar 5 (x2, score 7.57)](https://www.sudokuwiki.org/sudoku.htm?bd=....3..7....2..5...2...6.1..15..3.6...37.89...8.6..35..4.9...8...2..7....5..8....)
*   [Exemplar 6 (x2, score 7.60)](https://www.sudokuwiki.org/sudoku.htm?bd=2.........9.4.8.5...43......59...8..3..5.4..1......24...1..34...2.7.6.9.........3)
*   [Exemplar 7 (x2, score 7.62)](https://www.sudokuwiki.org/sudoku.htm?bd=7.5.9............2.4.3.69....3.25....84...53....8..6....84.3.6.5............5.8..)
*   [Exemplar 8 (x2, score 7.62)](https://www.sudokuwiki.org/sudoku.htm?bd=.1.9.4.6...4.3..8..7...2..45.9......7.......3......6.24..2...3..3..8.9...5.1.3.2.)
*   [Exemplar 9 (x2, score 7.66)](https://www.sudokuwiki.org/sudoku.htm?bd=.....2..4......6..74....51.81.79..2...........6..28.5...7.....99.5......6..4.....)

Go back to [Chute Remote Pairs](https://www.sudokuwiki.org/Chute_Remote_Pairs)Continue to [XY-Chains](https://www.sudokuwiki.org/XY_Chains)
...
[](https://www.sudokuwiki.org/Simple_Colouring)Comments[Talk](https://www.sudokuwiki.org/Simple_Colouring?talk#comments)
...
Now replaced the exemplars as the solver has moved on a lot since those were picked.
...
I can't see a simple colouring situation on 7. Can anyone else?
...
Is there a sudoku puzzle available , free or otherwise, that allows me to use this coloring technique? E

Andrew Stuart writes:

Eight exemplars at the end of the document you can load into the solver or player. All relatively trivial apart from the Simple Colouring steps
...
Thanks for the warning. Problems with progress! Will have to find another necessary example
...
If you load the example of "twice in a unit", you have to uncheck "chute remote pairs" in order for the solver to use simple colouring. I guess you put in "chute remote pairs" later, so it would have worked in the first place. A hint might be useful. 
...
In Simple Coloring Rule 2: C1=8 and C4=3?
...
Shows up for me stepping through the solver. But maybe another route to avoid
...
That two candidates with the same color are in the same row, box or column.
...
The solver uses the same search algorithm for both Singles Chains and 3D Medusa so I have synchronised the rule numbers that are returned. Rules 1 and 3 apply only to 3D Medusa (Multi-colouring) since they extend chains to different numbers.
...
Sounds like a discontinuity. They cannot both be the same colour since that implies they same same number twice. It's not necessarily a mistake in your chaining but a highlighting of a contradiction to be taken advantage of.
...
Correct. You are chaining your chains! The solver (and I) would break that down into two steps but yes you get a cascade there.
...
There is no chain starting with 3 on B5. Too many 3s in the row, column and box.
...
Because there are three 7s in row H, no link possible
...
J9 is not linked to E9 buy boxes. It is linked by their common column - where only two 5s exist. There are three 5s in column3 so there is no link between G3 and E3. Same with row E, four fives, so we can't connect to E3 and apply another rule.
...
Not everything, but mostly ;). It sounds like a handy rule when scanning with pen and paper. Just being aware of the different types and they'll get spotted. 
...
Good idea, I've added a line at the top before the first rule.
...
[Multi-Coloring Strategy](https://www.sudokuwiki.org/Multi_Colouring_Strategy)
...
I [found a sudoku](https://www.sudokuwiki.org/sudoku.htm?bd=000000004500712000963000010004009008000050000700800400010000765000546003300000000), which can demonstrate what I find an interesting twist to the colouring strategies:

The interesting part comes if you run it through the solver to the point where it uses simple colouring on 9s.

You get this: 

[CLICK](https://www.sudokuwiki.org/sudoku.htm?bd=271003584548712030963485217104079058680054071705801400410008765807546103356107840)
...
Yes but I used a screen shot of the previous step incorrectly. I have updated the diagram with 5 removed from E3.
...
It shouldn't matter which colour your start with or where you start. You should more or less get the same result.
...
[Crook's Algorithm](https://www.sudokuwiki.org/Crooks_Algorithm)
...
I was working on the [this puzzle](https://www.sudokuwiki.org/sudoku.htm?bd=008502103350001208021030050563240701482107530179053002030025810807310025215084300): 
...
Correct, I hadn't provided an example for this Rule for Simple Colouring, and your example is very good, so I've poached it. Rule 4 now added to the page above. Thanks for sharing and pointing it out.
...
I believe the example in Rule 5 happened before the examples above it. I have to search quite hard to find examples, and they are not always in the order of the documentation. Only that really :)
...
The connections you list are between cells that do not see each other, that is they share no common row, column or box. Not every cell can 'see' every other cell. A link is always along one common 'unit', sometimes two (same row and box for example).
...
Is there a way for a user of your site to color a single square?

Andrew Stuart writes:

There is now! Just not quite in 2009 :)
...
Brian replies:Thursday 25-Jun-2009
re: Clark
...
REPLY TO THIS POST
 ...
 Article created on 29-January-2011. Views: 855916

 This page was last modified on 4-April-2026.
