...
| Technique | Local Card | Primary Sources |
|---|---|---|
| Candidates and Links | `../techniques/00-foundations/candidates-and-links.md` | HODOKU-INTRO, HODOKU-CHAINS, SUDOKUWIKI-AIC |
| Singles | `../techniques/01-singles/singles.md` | HODOKU-SINGLES, SUDOPEDIA-SOLVING-TECHNIQUE |
| Locked Candidates | `../techniques/02-intersections/locked-candidates.md` | HODOKU-INTERSECTIONS, SUDOKUCOM-POINTING-PAIRS |
