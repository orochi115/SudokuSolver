...
Use stable citation IDs in technique cards and synthesis documents.
...
- `HODOKU-NAKED`: HoDoKu naked subsets page.
- `HODOKU-HIDDEN`: HoDoKu hidden subsets page.
...
- `HODOKU-CHAINS`: HoDoKu chains and loops page.
- `HODOKU-ALS`: HoDoKu ALS page.
- `HODOKU-UNIQUENESS`: HoDoKu uniqueness page.
- `HODOKU-MISC`: HoDoKu Sue de Coq page.
...
`Sources: HODOKU-BASIC-FISH, SUDOKUWIKI-XWING, SUDOKUCOM-ZH-XWING`

When drafting public-facing prose, cite URLs from `bibliography.md` rather than local file paths.
